...
const socialLinks = [
    ...
    {
        href: 'mailto:ali.majeed.mahdi@gmail.com',
        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M2 4.75C2 3.23122 3.23122 2 4.75 2H19.25C20.7688 2 22 3.23122 22 4.75V19.25C22 20.7688 20.7688 22 19.25 22H4.75C3.23122 22 2 20.7688 2 19.25V4.75ZM4.75 3.5C4.05964 3.5 3.5 4.05964 3.5 4.75V19.25C3.5 19.9404 4.05964 20.5 4.75 20.5H19.25C19.9404 20.5 20.5 19.9404 20.5 19.25V4.75C20.5 4.05964 19.9404 3.5 19.25 3.5H4.75ZM4.97 5.53C5.29289 5.20711 5.80711 5.20711 6.13 5.53L12 11.4L17.87 5.53C18.1929 5.20711 18.7071 5.20711 19.03 5.53C19.3529 5.85289 19.3529 6.36711 19.03 6.69L12.53 13.19C12.2372 13.4828 11.7628 13.4828 11.47 13.19L4.97 6.69C4.64711 6.36711 4.64711 5.85289 4.97 5.53Z" fill="currentColor" />
        </svg>,
        alt: 'Email'
    },
  ];
    ...
    return (
        ...
        >
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <form 
                    action="https://getform.io/f/awnnowrb" 
                    method="POST"
                    className="xl:pl-10 2xl-pl20"
                >
